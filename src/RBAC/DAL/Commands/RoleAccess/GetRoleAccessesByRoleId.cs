...
public class GetRoleAccessesByRoleId(Guid roleId, bool isActive = true, bool includeRole = true, bool includeAccess = true) : IRequest<List<RBAC.DAL.Models.RoleAccess>>
{
...
public class GetRoleAccessesByRoleIdSqlHandler(RbacSqlDbContext dbContext) : SqlRequestHandler<GetRoleAccessesByRoleId, List<RBAC.DAL.Models.RoleAccess>>(dbContext)
{
    public override async Task<List<RBAC.DAL.Models.RoleAccess>> Handle(GetRoleAccessesByRoleId request, CancellationToken cancellationToken)
    {
