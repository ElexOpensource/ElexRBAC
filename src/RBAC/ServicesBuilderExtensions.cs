...
namespace RBAC
{
    ...
    public static class ServicesBuilderExtensions
    {
        ...
        public static IApplicationBuilder UseRbac([NotNull] this IApplicationBuilder builder, [NotNull] string prefixPath = "/RBAC", [AllowNull] IDictionary<RbacTable, string> masterData = null)
        {
